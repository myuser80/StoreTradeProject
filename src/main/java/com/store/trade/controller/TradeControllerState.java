...
public class TradeControllerState extends ResponseEntityExceptionHandler{
    @ExceptionHandler(InvalidTradeNotSupportedException.class)
    public ResponseEntity<VndErrors> notFoundException(final InvalidTradeNotSupportedException e) {
